...
france({ nomCom: "developer", categorie: "General", reaction: "😇" }, async (dest, zk, commandeOptions) => {
    ...
    const devs = [
      { nom: "Mc Jackim", numero: "254712143384" },
      { nom: "Mc Jackim", numero: "254794961927" },
      // Ajoute d'autres développeurs ici avec leur nom et numéro
    ];

    let message = "Hello 👋\n *Welcome to JACKIM-MD!*\n\n*✦━━◆CREATOR INFO◆━━✦*\n\n\n *◇NAME: _Mc Jackim_*\n*◇AGE: 21*\n*◇LOCATION: _Kenya_*\n*◇BELIEVER: YES ✅*\n*◇FRIENDLY: YES ✅*\n*◇EGOISTIC: _YES ✅_*\n*◇FAV TEAM: _MANCHESTER UNITED_*\n*◇INSTAGRAM: https://instagram.com/mc.jackim_*\n*◇Twitter: https://twitter.com/jackim_mc*\n\n______________________________\n\n*💚KEEP USING JACKIM-MD🤍*\n\n\n_The following are my contacts_:\n:";
...
france({ nomCom: "support", categorie: "General" }, async (dest, zk, commandeOptions) => {
  ...
  await zk.sendMessage(auteurMessage,{text : `https://wa.me/254712143384`},{quoted :ms})
